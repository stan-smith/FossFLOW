...
const locale: LocaleProps = {
  ...
  lazyLoadingWelcome: {
    ...
    message:
      "Hey! After popular demand, we have implemented Lazy Loading of icons, so now if you want to enable non-standard icon packs you can enable them in the 'Configuration' section.",
